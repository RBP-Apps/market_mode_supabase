                          ...
                          <td style={{ ...cellStyle, padding: "0" }}>
                            <table style={{ width: "100%", borderCollapse: "collapse", border: "none" }}>
                              <tbody>
                                ...
                                <tr><td style={{ ...cellStyle, border: "none", borderBottom: `1px solid ${colors.border}` }}>Taxable Amount</td><td style={{ ...cellStyle, border: "none", borderBottom: `1px solid ${colors.border}`, textAlign: "right" }}>{fmt(afterDisc)}</td></tr>
