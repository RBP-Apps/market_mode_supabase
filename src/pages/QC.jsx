...
const PHYSICAL_INSPECTION_ITEMS = [
  { id: 1, text: "Anchor fasteners should be used at the time of Structure installation" },
  ...
  { id: 6, text: "Physical Proper installation of structure, Modules, Inverter, ACDB, DCDB, Lightning arresters, Earthings Etc." },
  { id: 7, text: "All wirings should be Proper & routed through Conduit Pipe" },
  ...
  { id: 12, text: "ACDB/DCDB/INVERTER should be properly mounted and Covered/Shield (To avoid Rain Water)" },
  { id: 13, text: "Inverter/ACDB/DCDB Body Earthing should be done (Double Earthing for Inverter)" },
  { id: 14, text: "AC & DC SPD Earthing should be Separate & Done" },
  { id: 15, text: "LA Earthing should be Separate" },
